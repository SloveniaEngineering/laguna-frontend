...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
        ...
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          if (screenHeight < 660) {
            return SingleChildScrollView(
                child: _generateRegisterForm(
                    screenWidth, screenHeight, isWideScreen, context));
          }
          return _generateRegisterForm(
              screenWidth, screenHeight, isWideScreen, context);
        },
      ),
    );
  ...
  Form _generateRegisterForm(double screenHeight, double screenWidth, bool isWideScreen, BuildContext context) {
    return Form(
          key: formKey,
          child: LandingBox(
